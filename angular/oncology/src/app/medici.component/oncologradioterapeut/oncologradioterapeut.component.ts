...
@Component({
  selector: 'app-oncologradioterapeut',
  templateUrl: './oncologradioterapeut.component.html',
  styleUrls: ['./oncologradioterapeut.component.css']
})
export class OncologradioterapeutComponent {
  title = 'blog';
  data: Array<Doctor>;
    ...
    this.medicService.getData().subscribe(
      data=>{
        ...
        for(var index in arrayFromResponse){
          if(arrayFromResponse[index].tip_doctor === "Oncolog Radioterapeut"){
