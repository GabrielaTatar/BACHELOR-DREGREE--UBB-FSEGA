...
@Component({
  selector: 'app-mediconcolog',
  templateUrl: './mediconcolog.component.html',
  styleUrls: ['./mediconcolog.component.css']
})
export class MediconcologComponent {
  title = 'blog';
  data: Array<Doctor>;
    ...
    this.medicService.getData().subscribe(
      data=>{
        ...
        for(var index in arrayFromResponse){
          if(arrayFromResponse[index].tip_doctor === "Medic Oncolog"){
