...
@Component({
  selector: 'app-oncologmedical',
  templateUrl: './oncologmedical.component.html',
  styleUrls: ['./oncologmedical.component.css']
})
export class OncologmedicalComponent {
  title = 'blog';
  data: Array<Doctor>;
    ...
    this.medicService.getData().subscribe(
      data=>{
        ...
        for(var index in arrayFromResponse){
          if(arrayFromResponse[index].tip_doctor === "Oncolog Medical"){
